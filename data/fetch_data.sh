...
) | csvdb "CREATE TABLE \"$TMP_DB\" AS SELECT 'TC_'||type AS code, MAKE_DATETIME(startYear,startMonth,startDay,startTime/100,startTime%100) AS start, MAKE_DATETIME(endYear,endMonth,endDay,endTime/100,endTime%100) AS end WHERE type != 'X'";
